...
class parse_message_Test extends PHPUnit_Framework_TestCase {
	...
	public function test_parse_message_i() {
		...
		$this->assertEquals($result, parse_message(preparse_bbcode(pun_trim($src), $errors), false));
	}
	...
	public function test_parse_message_url_1() {
		...
		$result = '<p><a href="http://localhost/fluxbb14/">Форум</a></p>';
		$src = '[url=http://localhost/fluxbb14/]Форум[/url]';
	...
	public function test_parse_message_url_2() {
		...
		$result = '<p><a href="http://localhost/fluxbb14/">http://localhost/fluxbb14/</a></p>';
		$src = '[url]http://localhost/fluxbb14/[/url]';
...
//	}
	...
	public function test_parse_message_quote_1() {
		...
		$result = '<div class="quotebox"><cite>James wrote:</cite><blockquote><div><p>This is the text I want to quote.</p></div></blockquote></div>';
	...
	public function test_parse_message_quote_2() {
		...
		$result = '<div class="quotebox"><blockquote><div><p>This is the text I want to quote.</p></div></blockquote></div>';
	...
	public function test_parse_message_quote_3() {
		...
		$result = '<div class="quotebox"><cite>Певица &#91;] Ёлка wrote:</cite><blockquote><div><p>This is the text I want to quote.</p></div></blockquote></div>';
	...
	$errors = array();
	$this-&gt;assertEquals($result, parse_message(preparse_bbcode(pun_trim($src), $errors), false));
}</code></pre></div><p><a href="http://яндекс.рф">http://яндекс.рф</a></p>';
...
http://яндекс.рф';
	...
	public function test_parse_message_img_in_url()
	{
		$errors = array();

		$result = '<p><a href="https://fluxbb.org/forums/"><span class="postimg"><img src="https://fluxbb.org/files/images/logo.png" alt="logo.png" /></span></a></p>';
		$src = "[url=https://fluxbb.org/forums/][img]https://fluxbb.org/files/images/logo.png[/img][/url]";

		$this->assertEquals($result, parse_message(preparse_bbcode(pun_trim($src), $errors), false));
	}


	public function test_parse_message_img_in_url_2()
	{
		$errors = array();

		$result = '<p><a href="https://fluxbb.org/files/images/logo.png"><span class="postimg"><img src="https://fluxbb.org/files/images/logo.png" alt="logo.png" /></span></a></p>';
		$src = "[url][img]https://fluxbb.org/files/images/logo.png[/img][/url]";
